...
\begin{frame}[c]
    ...
    \begin{center}
        \large Which interfaces do you need to implement your tempest plugin?
    \end{center}
\end{frame}
...
\begin{frame}[c]
    ...
    \begin{center}
        \large Which interfaces do you need to implement your CLI tests?
    \end{center}
\end{frame}

\begin{frame}
    \frametitle{CLI Tests Base Class}
    \begin{itemize}
        \item TBD
    \end{itemize}
\end{frame}
